...
const PLANS = [
  {
    ...
    badge: null,
    featured: false,
    description: "Get in the room. Access daily signals and the community.",
    features: [
      "Live trade alerts daily",
      "Private Discord access",
      "Weekly market recap",
      "Morning market prep sessions",
  ...
  },
  {
    ...
    badge: "MOST POPULAR",
    featured: true,
    description: "The full 🔝Floor system. Everything you need to start winning.",
    features: [
      "Everything in Bronze",
      "Full 🔝Floor trading curriculum",
      "Live trade sessions (Tue & Thu)",
      "Mid-week coaching breakdown",
      "Weekly game plan (Sundays)",
      "Daily market recaps",
    ],
    cta: "Join Silver",
  },
...
function PlanCard({ plan }: { plan: typeof PLANS[0] }) {
  ...
  return (
      ...
      style={
        plan.featured
          ? {
              ...
              boxShadow: "0 0 0 1px rgba(0,255,136,0.25), 0 0 50px rgba(0,255,136,0.08)",
            }
    ...
    >
      {plan.badge && (
        <div
          className="absolute -top-3 left-1/2 -translate-x-1/2 px-3 py-1 rounded-full text-xs font-bold tracking-widest whitespace-nowrap"
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 12 }}>
        <span
          style={{
            ...
            height: 10,
            borderRadius: "50%",
            background: plan.tierColor,
            flexShrink: 0,
          }}
        />
        <p
          className="text-xs font-bold tracking-widest uppercase"
          style={{ color: plan.tierColor, margin: 0 }}
        >
          {plan.name}
        </p>
      </div>
      ...
      <div className="flex items-end gap-1 mb-1">
        <span className="display-font text-5xl leading-none" style={{ color: plan.featured ? "#00ff88" : "#f5f5f5" }}>
          {plan.price}
        </span>
        ...
        {plan.features.map((f) => (
          <li key={f} className="flex items-start gap-3">
            <Check
              ...
              style={{ color: plan.featured ? "#00ff88" : plan.tierColor }}
            />
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6">
        <div className="flex-1">
          <div className="flex items-center gap-3 mb-2">
            <p className="text-xs font-bold tracking-widest uppercase" style={{ color: "#f0c040" }}>
              {LIFETIME.name}
            </p>
            <span
          ...
          <div className="flex items-end gap-2 mb-3">
            <span className="display-font text-5xl leading-none" style={{ color: "#f0c040" }}>
              {LIFETIME.price}
            </span>
        ...
        <button
          ...
          style={{ background: "#f0c040", color: "#000" }}
          onMouseEnter={(e) => (e.currentTarget.style.boxShadow = "0 0 25px rgba(240,192,64,0.5)")}
